...
import br.edu.ifg.model.dto.MesaRequestDTO;
import br.edu.ifg.model.dto.MesaResponseDTO;
...
public class MesaController {
    ...
    @Path("/{id}")
    @RolesAllowed("ADMIN")
    public Response editar(@PathParam("id") Long id, @Valid MesaRequestDTO dto) {
        try {
